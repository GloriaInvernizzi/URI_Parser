...
"  Verifica se un ottetto rappresentato da 3 numeri è valido.
(defun octet (codes)
  (cond
...
; sbagliato perchè csì considera solo se ogni ottetto ha 3 elementi da implementare anche per 2 sole cifre e 1 sola cifra
