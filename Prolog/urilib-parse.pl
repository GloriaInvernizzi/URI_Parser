...
%   destinazione. Nel caso di urilib_display/1 l'URI verr� stampato
...
%   Uno Schema seguito dal nulla � un URI valido.
...
%   lo Userinfo pu� essere l'unico componente presente all'interno di un
%   URI.
